...
echo What is your System Type:
    call :MsgBox "Are you a Desktop user?"  "VBYesNo+VBQuestion" "@3roSh"
    if errorlevel 7 (
        echo goto:LaptopPC 
...
@echo off
    ...
    call :MsgBox "Would you like Full Screen Exclusive? lower input delay & better performance but 3 second Alt-tab (black screen)"  "VBYesNo+VBQuestion" "@3roSh"
    if errorlevel 7 (
        echo NO - don't 
    ) else if errorlevel 6 (
        echo YES - Enable
...
if "%ERRORLEVEL%"=="0"     call :MsgBox "Would you like to close Chrome Browser to clear cache & Temp Files?"  "VBYesNo+VBQuestion" "@3roSh"
    if errorlevel 7 (
        goto:continueclean
    ) else if errorlevel 6 (
        echo YES - Enable
...
echo.
SET msgboxTitle=3roShBoost by @3roSh
SET msgboxBody=3roShBoost Tweaks Have been Applied, Please Restart your PC & Leave a feedback on the discord <3
...
@echo off
    ...
    call :MsgBox "Would you like to Restart?"  "VBYesNo+VBQuestion" "@3roSh"
    if errorlevel 7 (
...
tasklist /fi "ImageName eq chrome.exe" /fo csv 2>NUL | find /I "chrome.exe">NUL
if "%ERRORLEVEL%"=="1"     goto:continueclean
if "%ERRORLEVEL%"=="0"     call :MsgBox "Would you like to close Chrome Browser to clear cache & Temp Files?"  "VBYesNo+VBQuestion" "@3roShBoost"
    if errorlevel 7 (
        goto:continueclean
    ) else if errorlevel 6 (
        echo YES - Enable
...
echo                            _______________________________________________________________
echo                           ^|                                                               ^| 
echo                           ^|      3roShBoost: Info and Credits                             ^|
echo                           ^|      __________________________________________________       ^| 
echo                           ^|                                                               ^|
echo                           ^|      - @ ARAR AL-ALDOSRY (Dev)                                ^|
echo                           ^|                                                               ^|
echo                           ^|      - (3roSh#0502)                                           ^|
echo                           ^|                                                               ^|
echo                           ^|      [1] Back                                                 ^|
